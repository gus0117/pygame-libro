...
comidas = []
for i in range(20):
    comidas.append(pygame.Rect(random.randint(0, ANCHOVENTANA - TAMANIOCOMIDA), random.randint(0, ALTURAVENTANA - TAMANIOCOMIDA), TAMANIOCOMIDA, TAMANIOCOMIDA))
    ...
    for evento in pygame.event.get():
        ...
        if evento.type == KEYDOWN:
            ...
            if evento.key == K_UP or evento.key == ord('w'):
                moverseAbajo = False
                moverseArriba = True
            if evento.key == K_UP or evento.key == ord('s'):
                moverseArriba = False
                moverseAbajo = True
        ...
        if evento.type == MOUSEBUTTONUP:
            comidas.append(pygame.Rect(evento.pos[0], evento.pos[1], TAMANIOCOMIDA, TAMANIOCOMIDA))
        ...
        if contadorDeComida >= NUEVACOMIDA:
            ...
            # comprobar si el jugado ha intersectado alguno de los cuadrados de comida
